...
func (o *GetOrganizationsParams) WithPage(page *float64) *GetOrganizationsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get organizations params
func (o *GetOrganizationsParams) SetPage(page *float64) {
	o.Page = page
}

// WithPerPage adds the perPage to the get organizations params
func (o *GetOrganizationsParams) WithPerPage(perPage *float64) *GetOrganizationsParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the get organizations params
func (o *GetOrganizationsParams) SetPerPage(perPage *float64) {
	o.PerPage = perPage
}
