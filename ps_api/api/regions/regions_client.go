...
/*
GetRegions lists public regions
...
func (a *Client) GetRegions(params *GetRegionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRegionsOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for get_regions: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
